    ...
    public static double getQiblaDirectionFromNorth(double degLatitude,
        ...
        if (latitude2 > QIBLA_LATITUDE) {
            if ((longitude > QIBLA_LONGITUDE || longitude < (Math
                ...
                Log.d("Qibla Direction",
                        "longitude is greater in +180 and returnValue is in range 0..90");
                returnValue += 180;
                ...
                Log.d("Qibla Direction",
                        "longitude is not greater in +180 and returnValue is in range -90..0");
                returnValue += 180;
        ...
        if (latitude2 < QIBLA_LATITUDE) {
            Log.d("Qibla Direction", "latitude is less than QIBLA_Latitude");
            if ((longitude > QIBLA_LONGITUDE || longitude < (Math
                    .toRadians(-180d) + QIBLA_LONGITUDE))
                    && (returnValue > 0 && returnValue < 90)) {
                Log.d("Qibla Direction",
                        "longitude is greater in +180 and returnValue is in range -90..0");
                returnValue += 180;
            ...
            if (!(longitude > QIBLA_LONGITUDE || longitude < (Math
                    ...
                    && (returnValue > -90 && returnValue <= 0)) {
                Log.d("Qibla Direction",
                        "longitude is not greater in +180 and returnValue is in range 0..90");
                returnValue += 180;
            }
