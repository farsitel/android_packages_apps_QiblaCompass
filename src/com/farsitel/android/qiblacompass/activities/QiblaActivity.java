...
import com.farsitel.android.qiblacompass.util.LocationEnum;
...
public class QiblaActivity extends Activity implements AnimationListener,
    ...
    private void schedule() {
        Log.d(NAMAZ_LOG_TAG, "Scheduling a timerTask for every 1sec");
        if (timer == null) {
            timer = new Timer();
    ...
    private void cancelSchedule() {
        Log.d(NAMAZ_LOG_TAG, "Canceling a schedule of timerTask");
        if (timer == null)
            return;
        timer.cancel();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d(NAMAZ_LOG_TAG, "creating Namaz main Activity (onCreate started)");
        Log.d("Chert", "Salam gumbuli jun!!!!!!!!!");
        ...
        Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/kufi1.TTF");
    ...
    private double rotateImageView(double newAngle, double fromDegree,
        ...
        Log.d("NAMAZ_ROTATION", "imageView: right" + frameLayout.getRight()
                + " imageView.left: " + frameLayout.getLeft()
                + " imageView.top" + frameLayout.getTop()
                + " imageview.bottom: " + frameLayout.getBottom()
                + " Display width: " + main.getRight() + " Display height: "
                // + ((FrameLayout) frameLayout.getPaddingTop()
    ...
    private void useDefaultLocation(SharedPreferences perfs, String key) {
        ...
        Log.d("Qibla", "using default location: " + location.getLatitude() + ""
                + location.getLongitude());
        qiblaManager.onLocationChanged(location);
